...
"resource": {
  ...
  "rules":[
    ...
    [["if",6,59],["add",78]],
    [["if",6,7,38],["add",82,83]],
    [["if",62,63,64,65],["add",85]],
    [["if",63,65],["add",89]],
    [["if",54,66],["add",2]],
    [["if",54,67],["add",95]],
    [["if",54,68],["add",96]],
    [["if",5,69],["add",106,107,108]],
    [["if",6,7,69],["add",108]],
    [["if",3,56,69],["add",109]],
    [["if",15,30,69],["add",110]],
    [["if",54,69,70],["add",111]],
    [["if",13,14,15,69],["add",112]],
    [["if",5,34,69],["add",113]],
    [["if",5,71],["add",114]],
